...
public class AnchorScrollViewManager
    ...
    public void setBorderRadius(AnchorScrollView view, int index, float borderRadius) {
    ...
    public void setBorderStyle(AnchorScrollView view, @Nullable String borderStyle) {
    ...
    public void setBorderWidth(AnchorScrollView view, int index, float width) {
    ...
    public void setBorderColor(AnchorScrollView view, int index, Integer color) {
        float rgbComponent =
